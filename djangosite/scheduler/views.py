...
def student_detail(request, student_id):
    ...
    return render_to_response('scheduler/students_detail.html',{'student':student,'registered_courses':registered_courses},
...
def teacher_detail(request, teacher_id):
    ...
    return render_to_response('scheduler/teachers_detail.html',{'teacher':teacher, 'courses_taught':courses_taught},
                              context_instance=RequestContext(request))
...
def course_detail(request, course_id):
    ...
    return render_to_response('scheduler/courses_detail.html',{'course':course, 'teacher':teacher, 'register_count':register_count},
                              context_instance=RequestContext(request))
